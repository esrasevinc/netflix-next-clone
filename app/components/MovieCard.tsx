...
const MovieCard : React.FC<MovieCardProps> = ({ data }) => {
  ...
  return (
    <div className='group bg-zinc-900 relative col-span h-[12vw]'>
      <img className='cursor-pointer object-cover transition duration shadow-xl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0 w-full delay-300 h-[12vw]' 
